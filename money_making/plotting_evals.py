...
# model_folder = os.path.expanduser("~/money_making_new/v1_alt_clean/models")
# load_dir = os.path.expanduser("~/money_making_new/v1_alt_clean/data_gpt_neo_x_tokenizer")
# extra_name = "[Primary version] "

# model_folder = os.path.expanduser("~/money_making_new/v1/models")
# load_dir = os.path.expanduser("~/money_making_new/v1/data_gpt_neo_x_tokenizer")
# extra_name = "[No ELI5] "


# model_folder = os.path.expanduser("~/money_making/v4/models")
# load_dir = os.path.expanduser("~/money_making/v4/data_gpt_neo_x_tokenizer")
# extra_name = "[Easy] "

# model_folder = os.path.expanduser("~/money_making_new/v1_alt_clean_tamp_hint/models")
# load_dir = os.path.expanduser("~/money_making_new/v1_alt_clean_tamp_hint/data_gpt_neo_x_tokenizer")
# extra_name = "[Evidence for tamper is obvious] "
...
for model in ["pythia-1.4b-d"]:
    ...
    curves_displayed = [
        ...
        # "inconsisd_cn_dirty_probe",
        "inconsisd_chn_dirty",
        # "inconsisd_cn_dirty",
        # "tampd_cet_dirty_probe",
...
if main_plot:
    plt.title(f"Generated stories {extra_name}(Pythia-1.4B)")
