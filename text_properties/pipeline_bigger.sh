...
train_and_evaluate() {
    ...
    if [ $DO_TRAIN -eq 1 ]; then
        ...
        accelerate launch --main_process_port 29603 --num_processes $num_processes $accelerate_args elk/func_correct/train_fsdp.py --model_name_or_path $model --output_dir $output_dir $train_args || exit 1
    fi
