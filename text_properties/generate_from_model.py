...
from text_properties.simplified_data_types import SimpleFullDatum, SimpleFullDatumWithGen
from text_properties.training_data_prompts import writing_response_to_full_prompt
