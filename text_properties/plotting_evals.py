...
for model in ["mpt-7b-pre"]:
    ...
    curves_displayed = [
        ...
        # "inconsisd_lower_lr_chn_dirty_probe",
        # "inconsisd_way_lower_lr_chn_dirty_probe",
    ]
    # (model, epoch)
    datas_curves = {
...
plt.ylim(bottom=0.25, top=1)
if main_plot:
    plt.ylim(0, 1)
    plt.title("Text properties (MPT-7B)")
